            ...
            <div class="container">
                <form class="row" action="/passer-commande" method="POST">
                    ...
                    <div class="col-md-6 mb-5 mb-md-0">
                        <h2 class="h3 mb-3 text-black">Livraison</h2>
...
>>>>>>> ba578d9502cb88d0be689137198dd96d2792b992
                            ...
                            <div class="form-group row mt-5">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="c_address" required name="c_address"
                                        placeholder="Adresse">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="c_address" required
                                        name="c_ville" placeholder="Ville">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="c_email_address" required
                                        name="c_email_address" placeholder="user@example.com">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="p-3 p-lg-5 border">
                                    <table class="table site-block-order-table mb-5">
                                        ...
                                        <tbody>
                                            @foreach ($cart as $item)
                                                <tr>
                                                    <td>{{ $item['item']->nom }} <strong class="mx-2">x</strong>
                                                        {{ $item['quantity'] }}</td>
                                                    <td>{{ $item['item']->prix }} DH</td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Total du
                                                        panier</strong></td>
                                                <td class="text-black">{{ $total }} DH</td> 
                                            </tr>
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Fraix de
                                                        livraison</strong></td>
                                                <td class="text-black">20.00 DH</td>
                                            </tr>
                                            <tr>
                                                <td class="text-black font-weight-bold"><strong>Total de la
                                                        commande</strong></td>
                                                <td class="text-black font-weight-bold" name="fraix"><strong>{{ number_format($FraixTotal, 2) }}
                                                        DH</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="border mb-3">
                                        <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse"
                                                ...
                                                aria-controls="collapsebank">Virement bancaire direct</a></h3>

                                        <div class="collapse" id="collapsebank">
                                            <div class="py-2 px-4">
                                                <p class="mb-0">Effectuez votre paiement directement sur notre compte
                                                    bancaire. Veuillez utiliser votre
                                                    numéro de commande comme référence de paiement. Votre commande ne
                                                    sera pas expédiée tant que les fonds n'auront pas
                                    ...
                                    <div class="border mb-3">
                                        <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse"
                                                ...
                                                aria-controls="collapsecheque">Paiement par chèque</a></h3>

                                        <div class="collapse" id="collapsecheque">
                                            <div class="py-2 px-4">
                                                <p class="mb-0">Effectuez votre paiement par chèque. Veuillez
                                                    utiliser votre numéro de commande comme
                                                    référence de paiement. Votre commande ne sera pas expédiée tant que
                                                    les fonds n'auront pas été crédités
                                                    sur notre compte.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border mb-5">
                                        ...
                                        <div class="collapse" id="collapsepaypal">
                                            <div class="py-2 px-4">
                                                <p class="mb-0">Effectuez votre paiement via Paypal. Veuillez
                                                    utiliser votre numéro de commande comme
                                                    référence de paiement. Votre commande ne sera pas expédiée tant que
                                                    les fonds n'auront pas été crédités
                                                    sur notre compte.</p>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-block">Passer
                        ...
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <a href="#" class="banner-1 h-100 d-flex"
                                ...
                                <div class="banner-1-inner ml-auto  align-self-center">
                                    ...
                                    <p>En cas d'urgence médicale, vous pouvez appeler directement un docteur et passer
                                        votre
                        ...
                        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                            ...
                            <div class="block-7">
                                ...
                                <p>
                                    ...
                                    exceptionnels.
                                    Notre mission est de rendre l'accès aux médicaments plus facile et plus pratique
                                    pour
                                    vous,
                    ...
                    <div class="row pt-5 mt-5 text-center">
                        <div class="col-md-12">
                            <p>
                                ...
                                avec <i class="icon-heart" aria-hidden="true"></i> par <a href=""
                                    target="_blank" class="text-primary">Pharma</a>
                            </p>
                        </div>
                    </div>
                </div>
