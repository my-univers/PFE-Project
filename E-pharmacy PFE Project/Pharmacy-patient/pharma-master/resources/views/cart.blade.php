                                        ...
                                        @foreach ($cart as $item)
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a
                                                        @if ($item['type'] == 'product') href="/product-details/{{ $item['item']->id }}" @elseif($item['type'] == 'pack') href="/pack-details/{{ $item['item']->id }}" @endif>
                                                        <img src="{{ $item['item']->image_path }}" alt="Image"
                                                            width="100">
                                                    </a>
                                                </td>
                        ...
                        <div class="row mb-5">
                            @if ($total > 0)
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <a href="/cart/cancelCart" class="btn btn-primary btn-md btn-block">Annuler
                                        l'achat</a>
                                </div>
                            @endif
                            <div class="col-md-6">
                                <a href="/shop/produits" class="btn btn-outline-primary btn-md btn-block">Continuer
                                    les achats</a>
                            </div>
                        </div>
                    </div>
