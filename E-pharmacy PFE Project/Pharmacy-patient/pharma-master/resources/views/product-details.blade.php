                                    ...
                                    <form method="POST" action="{{ route('add.to.cart') }}">
                                        ...
                                        <div class="mb-5">
                                            <div class="input-group mb-3" style="max-width: 220px;">
                                                ...
                                                <input type="text" style="background-color: white" class="form-control text-center" name="quantity" value="1" placeholder=""
                                                    aria-label="Example text with button addon" aria-describedby="button-addon1"
                        ...
                        @else
                            <div class="mb-5">
                                <div class="input-group mb-3" style="max-width: 220px;">
                                    ...
                                    <input type="text" style="background-color: white" class="form-control text-center" name="quantity"
