...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
          <div class="row">
              <div class="col-md-12 mb-0"><a href="/">Accueil</a> <span class="mx-2 mb-0">/</span> <a href="/shop">Magasin</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">{{$product->nom}}</strong></div>
          </div>
      </div>
  </div>
          ...
          <div class="col-md-6">
            ...
            @if($product->ordonnance)
              ...
              <button href="/cart" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" disabled>Ajouter au Panier</button>              
               ...
               @if($product->ordonnance_path)
               <button href="/cart" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Ajouter au Panier</button>
               @endif
            {{-- ila kan bla ordonnance --}}
            @else
            <p><a href="/cart" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Ajouter au Panier</a></p>
            @endif
