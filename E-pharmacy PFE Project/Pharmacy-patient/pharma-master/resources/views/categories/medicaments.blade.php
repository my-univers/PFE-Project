...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0">
                        ...
                        <strong class="text-black">Médicaments</strong>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        <a href="{{ route('shop-single', $medicament->id) }}"> <img class="medicament-image" src="{{ asset($medicament->image_path) }}" alt="Image"></a>
                        <br><br>
                        <h3 class="text-dark"><a href="{{ route('shop-single', $medicament->id) }}">{{ $medicament->nom }}</a></h3>
                        <p class="price">{{ $medicament->prix }} DH</p>
                      </div>
                      <style>
                        .medicament-image {
                            height: 200px;
                    ...
                    <div class="col-md-12 text-center">
                        <div class="site-block-27">
                            <ul>
                                ...
                                @else
                                    <li><a href="{{ $medicaments->previousPageUrl() }}">&lt;</a></li>
                                @endif

                                <!-- Affichage des pages -->
                                @foreach ($medicaments->getUrlRange(1, $medicaments->lastPage()) as $page => $url)
                                    @if ($medicaments->currentPage() === $page)
                                ...
                                @if ($medicaments->hasMorePages())
                                    <li><a href="{{ $medicaments->nextPageUrl() }}">&gt;</a></li>
                                @else
                                    <li class="disabled"><span>&gt;</span></li>
                                @endif
                            </ul>
    ...
    {{-- <div class="row">
        @foreach ($medicaments as $medicament)
            <div class="col-sm-6 col-lg-4 text-center item mb-4">
                <a href= "shop-single/ {{ $medicament->id }}">
                    <img src="{{ asset($medicament->image_path) }}" alt="Image"class="product-image">
                    <style>
                        .product-image {
                            width: 200px;
                            height: 200px;
                ...
                <h3 class="text-dark"><a href="shop-single/ {{ $medicament->id }}">{{ $medicament->nom }}</a></h3>
                <p class="price">{{ $medicament->prix }} DH</p>
            </div>
        @endforeach
    </div>
