                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                        <a class="dropdown-item" href="/complementsFiltered?sort=relevance">Pertinence</a>
                        <a class="dropdown-item" href="/complementsFiltered?sort=nom_asc">Nom, A à Z</a>
                        <a class="dropdown-item" href="/complementsFiltered?sort=nom_desc">Nom, Z à A</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/complementsFiltered?sort=prix_asc">Prix, croissant</a>
                        <a class="dropdown-item" href="/complementsFiltered?sort=prix_desc">Prix, décroissant</a>
                    </div>
                </div>
                </div>
                ...
                <div class="row mt-5">
                    @foreach ($complements as $complement)
                        <div class="col-sm-6 col-lg-4 text-center item mb-4">
                            <a href="{{ route('shop-single', $complement->id) }}"> <img class="complement-image"
                                    src="{{ asset($complement->image_path) }}" alt="Image"></a>
                            <br><br>
                            <h3 class="text-dark"><a href="{{ route('shop-single', $complement->id) }}">{{ $complement->nom }}</a>
                            </h3>
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-center">
                        <div class="site-block-27">
                            <ul>
                                <!-- Bouton précédent -->
                                @if ($complements->onFirstPage())
                                    <li class="disabled"><span>&lt;</span></li>
                                @else
                                    <li><a href="{{ $complements->previousPageUrl() }}">&lt;</a></li>
                                @endif

                                <!-- Affichage des pages -->
                                @foreach ($complements->getUrlRange(1, $complements->lastPage()) as $page => $url)
                                    @if ($complements->currentPage() === $page)
                                ...
                                <!-- Bouton suivant -->
                                @if ($complements->hasMorePages())
                                    <li><a href="{{ $complements->nextPageUrl() }}">&gt;</a></li>
                                @else
                                    <li class="disabled"><span>&gt;</span></li>
                                @endif
                            </ul>
